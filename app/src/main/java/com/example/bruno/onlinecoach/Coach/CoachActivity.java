...
public class CoachActivity extends AppCompatActivity implements
    ...
    @Override
    public void onStudentListFragmentInteraction(StudentDummy item) {
        Toast.makeText(this, item.name + " pressed", Toast.LENGTH_SHORT).show();
    ...
    public void OnTrainingListFragmentInteractionListener(Exercise exercise) {
        Toast.makeText(this, exercise.getName() + " pressed", Toast.LENGTH_SHORT).show();
    }
